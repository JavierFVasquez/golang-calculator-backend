...
import (
	...
	"github.com/JavierFVasquez/truenorth-calculator-backend/v1/multiplication/controllers"
...
func main() {
	...
	multiplicationController := controllers.NewMultiplicationController(basicOperationService)

	lambda.Start(multiplicationController.MultiplicationController)
}
