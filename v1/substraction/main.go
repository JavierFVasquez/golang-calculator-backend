...
import (
	...
	"github.com/JavierFVasquez/truenorth-calculator-backend/v1/substraction/controllers"
...
func main() {
	...
	substractionController := controllers.NewSubstractionController(basicOperationService)

	lambda.Start(substractionController.SubstractionController)
}
